...
class Cache(object):
    ...
    def get_user_name(self, user_id):
        ...
        if user_id in self.cached_names:
            ...
            # cache miss
            user_name = read_through_cache.get_user_by_id.getUserByID(user_id)
    ...
    def __insert_entry(self, user_name, user_id):
        ...
        self.mru_index += 1
        self.cached_names[user_id] = [user_name, self. mru_index]
    ...
    def __evict_lru_entries(self):
        ...
        min_mru_index = None
        for user_id, user_entry in self.cached_names.iteritems():
            if min_mru_index is None or min_mru_index > user_entry[1]:
                min_mru_index = user_entry[1]
                min_user_id = user_id
        del self.cached_names[min_user_id]
